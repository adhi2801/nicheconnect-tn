...
| Cache and rate limits | Valkey 9.1.2 or newer | **Locked** |
...
| Cache and limits store | Redis 7 | **Valkey 9.1** (9.1.2 or newer; 9.1.1 fixed critical TLS and stream bugs. BSD licence, Linux Foundation, up to 17% more throughput in 9.1; Amazon ElastiCache supports it), or Redis 8 (AGPL) | Open licence, faster; drop-in for our use | Recommended | Next |
